{{-- resources/views/admin/servicos/edit.blade.php --}}
@extends('adminlte::page')

@section('title', 'Editar Serviço - PetShop')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="duracao_minutos" id="duracao_minutos" min="1"
                                   ...
                                   value="{{ old('duracao_minutos', $servico->duracao_minutos) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="ativo" id="ativo" 
                                ...
                                <option value="1" {{ old('ativo', $servico->ativo) ? 'selected' : '' }}>Ativo</option>
                                <option value="0" {{ !old('ativo', $servico->ativo) ? 'selected' : '' }}>Inativo</option>
                            </select>
                            @error('ativo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
