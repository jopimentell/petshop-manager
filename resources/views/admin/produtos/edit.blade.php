{{-- resources/views/admin/produtos/edit.blade.php --}}
@extends('adminlte::page')

@section('title', 'Editar Produto - PetShop')
        ...
        <div class="card-body">
            <form action="{{ route('admin.produtos.update', $produto) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="preco_custo" id="preco_custo" step="0.01" min="0"
                                       ...
                                       value="{{ old('preco_custo', $produto->preco_custo) }}" required>
                                @error('preco_custo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="estoque_minimo" id="estoque_minimo" min="0"
                                   ...
                                   value="{{ old('estoque_minimo', $produto->estoque_minimo) }}" required>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.produtos.show', $produto) }}" class="btn btn-default">
                        Cancelar
                    </a>
                </div>
            </form>
