...
@section('title', 'Editar Cliente - PetShop')
            ...
            <form action="{{ route('admin.clientes.update', $cliente) }}" method="POST">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="cpf" id="cpf" 
                                   ...
                                   value="{{ old('cpf', $cliente->cpf) }}" required maxlength="11">
                            @error('cpf')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="endereco" id="endereco" 
                              ...
                              rows="3" required>{{ old('endereco', $cliente->endereco) }}</textarea>
                    @error('endereco')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.clientes.show', $cliente) }}" class="btn btn-default">
                        Cancelar
                    </a>
                </div>
            </form>
